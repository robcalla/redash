...
def get_settings_with_defaults(defaults, org):
    ...
    settings['auth_wso2_apps_domains'] = org.wso2_apps_domains
...
class OrganizationSettings(BaseResource):
    ...
    def post(self):
        ...
        for k, v in new_values.iteritems():
            ...
            elif k == 'auth_wso2_apps_domains':
                previous_values[k] = self.current_org.wso2_apps_domains
                self.current_org.settings[Organization.SETTING_WSO2_APPS_DOMAINS] = v
            else:
